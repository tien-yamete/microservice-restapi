...
public class ProductController {
    ...
    public ResponseEntity<ApiResponse<ProductResponse>> create(@Valid @RequestBody ProductCreateRequest request) {
        ...
        return ResponseEntity.ok(ApiResponse.<ProductResponse>builder().result(result).build());
    }
    ...
    public ResponseEntity<ApiResponse<Page<ProductResponse>>> search(
        ...
        Page<ProductResponse> result = productService.search(q, categoryId, brandId, minPrice, maxPrice, active, page, size, sortBy, sortDir);
        return ResponseEntity.ok(ApiResponse.<Page<ProductResponse>>builder().result(result).build());
    }
}